 ...
 *
 */
class InvitesEventFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'invites_event_ibfk_1' => ['type' => 'foreign', 'columns' => ['event'], 'references' => ['events', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'invites_event_ibfk_2' => ['type' => 'foreign', 'columns' => ['user_inviting'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'invites_event_ibfk_3' => ['type' => 'foreign', 'columns' => ['user_invited'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
