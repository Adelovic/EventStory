...
use App\View\Cell\SearchCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\SearchCell Test Case
 */
class SearchCellTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Search = new SearchCell($this->request, $this->response);
    }
